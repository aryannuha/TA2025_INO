/* 
 Nama File      : MODUL_WINDSPEED.ino
 Tanggal Update : 09 Juni 2025
 Dibuat oleh    : Ammar Aryan Nuha
 MAC            : F4:65:0B:54:C9:90
 IP Address     : 192.168.0.234
 Penjelasan     : 
    1. Program ini digunakan untuk membaca data Windspeed dari sensor Windspeed yang terhubung ke ESP32.
    2. Data yang dibaca akan dikirim ke beberapa tujuan melalui protokol UDP.
    3. Program ini juga menyimpan data Windspeed dalam EEPROM untuk keperluan regresi linear.
...
void loop() {
  ...
  if (currentMillis - last_reading >= 60000){
    ...
    add_data_point(time_counter, windspeedData.data);
