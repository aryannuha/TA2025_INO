/* 
 ...
 Penjelasan     : 
    1. Fungsi machine_learning() digunakan untuk melakukan regresi linear pada data Windspeed.
    2. Fungsi add_data_point() digunakan untuk menambahkan data baru ke dalam model regresi.
    3. Fungsi predict() digunakan untuk memprediksi nilai Windspeed berdasarkan model regresi.
