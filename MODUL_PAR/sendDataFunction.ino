/* 
 ...
 Penjelasan     : 
    1. Fungsi sendData() digunakan untuk mengirim data PAR dalam format JSON ke beberapa tujuan melalui protokol UDP.
    2. Data yang dikirim meliputi kode modul, kode variabel, data, kode alarm, dan berita.
    3. Fungsi ini juga mengirimkan prediksi PAR untuk periode waktu t+1 t+2, t+3, t+4, dan t+5.
...
// BUAT DOKUMEN JSON UNTUK prediksi 1 menit ke depan par
  StaticJsonDocument<200> doc1;
  doc1["kodeModul"] = parData.kodeModul;
  ...
  // DELAY 1 DETIK SEBELUM MENGIRIM JSON par
  delay(50);

  // BUAT DOKUMEN JSON UNTUK prediksi 2 menit ke depan par
  StaticJsonDocument<200> doc2;
  doc2["kodeModul"] = parData.kodeModul;
  ...
  // BUAT DOKUMEN JSON UNTUK prediksi 3 menit ke depan par
  StaticJsonDocument<200> doc3;
  doc3["kodeModul"] = parData.kodeModul;
  ...
  // BUAT DOKUMEN JSON UNTUK prediksi 4 menit ke depan par
  StaticJsonDocument<200> doc4;
  doc4["kodeModul"] = parData.kodeModul;
  ...
  // BUAT DOKUMEN JSON UNTUK prediksi 5 menit ke depan par
  StaticJsonDocument<200> doc5;
  doc5["kodeModul"] = parData.kodeModul;
