/* 
 ...
 Penjelasan     : 
    1. Fungsi displayDebug() digunakan untuk menampilkan nilai-nilai dari persamaan regresi linear PAR.
    2. Fungsi ini akan mencetak nilai-nilai seperti suhu, kelembaban, jumlah data, dan koefisien regresi ke serial monitor.
    3. Fungsi showPredict() digunakan untuk menampilkan prediksi nilai PAR untuk periode waktu t+1 hingga t+5.
...
void displayDebug(){
  ...
  Serial.print(parData.data); Serial.print(", ");
