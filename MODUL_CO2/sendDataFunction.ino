/* 
 ...
 Penjelasan     : 
    1. Fungsi sendData() digunakan untuk mengirim data CO2 dalam format JSON ke beberapa tujuan melalui protokol UDP.
    2. Data yang dikirim meliputi kode modul, kode variabel, data, kode alarm, dan berita.
    3. Fungsi ini juga mengirimkan prediksi CO2 untuk periode waktu t+1 t+2, t+3, t+4, dan t+5.
...
// BUAT DOKUMEN JSON UNTUK prediksi 1 menit ke depan co2
  StaticJsonDocument<200> doc1;
  doc1["kodeModul"] = co2Data.kodeModul;
  ...
  // DELAY 1 DETIK SEBELUM MENGIRIM JSON co2
  delay(50);

  // BUAT DOKUMEN JSON UNTUK prediksi 2 menit ke depan co2
  StaticJsonDocument<200> doc2;
  doc2["kodeModul"] = co2Data.kodeModul;
  ...
  // BUAT DOKUMEN JSON UNTUK prediksi 3 menit ke depan co2
  StaticJsonDocument<200> doc3;
  doc3["kodeModul"] = co2Data.kodeModul;
  ...
  // BUAT DOKUMEN JSON UNTUK prediksi 4 menit ke depan co2
  StaticJsonDocument<200> doc4;
  doc4["kodeModul"] = co2Data.kodeModul;
  ...
  // BUAT DOKUMEN JSON UNTUK prediksi 5 menit ke depan co2
  StaticJsonDocument<200> doc5;
  doc5["kodeModul"] = co2Data.kodeModul;
