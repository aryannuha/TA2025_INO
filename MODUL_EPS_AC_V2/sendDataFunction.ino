/* 
 ...
 Penjelasan     : 
    1. Fungsi ini digunakan untuk mengirimkan data ke beberapa IP tujuan dalam format JSON.
    2. Fungsi ini akan mengirimkan data tegangan, arus, dan daya yang sudah diproses.
    3. Fungsi ini akan mengirimkan data ke IP tujuan menggunakan protokol komunikasi UDP.
    4. Fungsi ini akan menampilkan payload yang dikirimkan di serial monitor.
*/
