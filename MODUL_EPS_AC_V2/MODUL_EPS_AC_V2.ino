/* 
 Nama File      : MODUL_EPS_AC.ino
 Tanggal Update : 09 Juni 2025
 Dibuat oleh    : Ammar Aryan Nuha
 MAC            : F4:65:0B:5B:06:68
 IP Address     : 192.168.0.242
 Penjelasan     : 
    1. Modul ini digunakan untuk membaca data dari PZEM-004T 10A yang sudah dikalibrasi.
    2. Modul ini akan mengirimkan data ke beberapa IP tujuan, yaitu:
       - RIDAM CLOUD A 
       - RIDAM LOCAL A 
       - ALARM MCS
       - DATALOGGER MCS
    3. Modul ini juga akan menampilkan data di serial monitor.
    4. Modul ini menggunakan library PZEM004Tv30, WiFi, WiFiClientSecure, HTTPClient, AsyncUDP, dan ArduinoJson.
    5. Modul ini menggunakan struktur data untuk mengirimkan data ke IP tujuan.
    6. Modul ini menggunakan kalibrasi untuk mengubah nilai tegangan, arus, dan daya yang dibaca dari PZEM-004T.
    7. Modul ini menggunakan simple moving average untuk menghaluskan data yang dibaca dari PZEM-004T jika dibutuhkan.
    8. Modul ini menggunakan IP static untuk koneksi WiFi.
    9. Modul ini menggunakan interval 1 detik untuk pembacaan data dari PZEM-004T.
*/
