// ================================================== FUNGSI proses() =======================================================================================
void proses(){
  // DEKLARASI UNTUK WAKTU GANTI DISPLAY
  // unsigned long nowDisplayMillis = millis();
  ...
  // PANGGIL FUNGSI displayLCD()
  // if(nowDisplayMillis - displayChangeMillis >= displayChangeInterval){
  //   displayChangeMillis = nowDisplayMillis;
  //   displayLCD();
  // }
}
// ========================================================== AKHIR FUNGSI proses() =========================================================================
